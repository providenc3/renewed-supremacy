...
public:
	...
	Checkbox	  autopistol;
	Checkbox	  hitchance_pistol;
	Slider		  hitchance_amountpistol;
	Slider		  pistol_minimaldamage;
...
public:
	void init() {
		...
		hitchance_amountpistol.setup("pistol hitchance", XOR("hitchance_amountpistol"), 1.f, 100.f, false, 0,50.f, 1.f, XOR(L"%"));
		hitchance_pistol.AddShowCallback(callbacks::IsHitchanceOn);
		RegisterElement(&hitchance_amountpistol);

		pistol_minimaldamage.setup(XOR("minimum damage"), XOR("pistol minimal_damage"), 1.f, 126.f, true, 0, 40.f, 1.f);
		RegisterElement(&pistol_minimaldamage);
...
public:
	void init() {
		...
		enable_use.setup(XOR("anti-aim on use"), XOR("enable_use"));
		RegisterElement(&enable_use);
		...
		slide_type.setup("legs", XOR("slide_type"), { XOR("prefer walking"), XOR("prefer sliding") }, true);
		RegisterElement(&slide_type, 1);
	}
};
...
public:
	void init() {
		...
		flags_enemy.setup(XOR("flags enemy"), XOR("flags_enemy"), { XOR("money"), XOR("armor"), XOR("zoom"), XOR("flashed"), XOR("reload"), XOR("bomb"), XOR("fake"), XOR("lethal"), XOR("tickbase"), XOR("hit"),XOR("ping"),XOR("cheat reveal"),XOR("resolver modes")});
		...
		offscreen_mode.setup(XOR("offscreen size"), XOR("offscreen_mode"), 1.f, 20.f, true, 0, 100.f, 1.f, XOR(L""));
...
public:
	void init( ) {
		...
		manualaa_alpha.setup(XOR("color transparency"), XOR("manualaa_alpha"), 0.f, 255.f, true, 0.f, 1.f, 1.f, XOR(L"%"));
		manualaa_alpha.AddShowCallback(callbacks::manualaa);
		RegisterElement(&manualaa_alpha, 1);
...
public:
	void init( ) {
		...
		fake_latency_amt.setup("", XOR("fake_latency_amt"), 50.f, 800.f, false, 0, 200.f, 10.f, XOR(L"ms"));
		...
		secondary_fake_latency_amt.setup("", XOR("secondary_fake_latency_amt"), 50.f, 600.f, false, 0, 200.f, 50.f, XOR(L"ms"));
		...
		whitelist.setup(XOR("whitelist same users"), XOR("whitelist"));
